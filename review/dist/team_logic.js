(function(root){
 ...
 const api={numeric,match,matches,compatible,exclusionNames,conflict,commonFactions,partnerSet,reason,tally};root.TeamLogic=api;if(typeof module!=='undefined')module.exports=api;
})(globalThis);
